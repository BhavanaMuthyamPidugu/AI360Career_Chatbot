...
import { Sparkles, Bot, Target, LineChart, Users, Zap, Search } from "lucide-react";
...
// A helper component for feature cards
    ...
    <div className="w-full bg-white">
      ...
      <header className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <nav className="flex items-center gap-4">
          ...
          <Link
            href="/chat"
            className="px-4 py-2 rounded-md bg-blue-600 text-white font-semibold shadow-sm hover:bg-blue-700 transition-colors"
          >
            Get Started
          </Link>
        </nav>
      ...
      <main className="container mx-auto px-6">
        ...
        <section className="text-center py-20 lg:py-32">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mt-6">
            Transform your career journey with personalized AI guidance, market insights, and intelligent
            recommendations powered by cutting-edge RAG technology.
          </p>

          <div className="mt-10 flex justify-center gap-4">
            <Link
              href="/onboarding"
              className="px-6 py-3 rounded-lg bg-blue-600 text-white font-semibold shadow-md hover:bg-blue-700 transition-all transform hover:scale-105"
            >
              Start Your Journey
            </Link>
            <Link
              href="/chat"
              className="px-6 py-3 rounded-lg bg-white text-gray-700 font-semibold border border-gray-300 shadow-sm hover:bg-gray-50 transition-all transform hover:scale-105"
            >
              Watch Demo
            </Link>
          </div>
        ...
        <section className="py-20 lg:py-24">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900">
              Advanced Features for Your Success
            </h2>
